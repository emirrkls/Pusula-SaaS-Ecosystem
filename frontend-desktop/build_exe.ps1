...
$installerPath = "target\installer\Pusula-Servis-Yonetimi-3.6.0.msi"
Copy-Item "target\installer\Pusula Servis Yonetimi-3.6.0.msi" `
...
Write-Host "Konum: frontend-desktop\target\installer\Pusula-Servis-Yonetimi-3.6.0.msi" -ForegroundColor Green
Write-Host "========================================================" -ForegroundColor Green
