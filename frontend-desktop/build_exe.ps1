...
$installerPath = "target\installer\Pusula-Servis-Yonetimi-3.5.5.msi"
Copy-Item "target\installer\Pusula Servis Yonetimi-3.5.5.msi" `
...
Write-Host "Konum: frontend-desktop\target\installer\Pusula-Servis-Yonetimi-3.5.5.msi" -ForegroundColor Green
Write-Host "========================================================" -ForegroundColor Green
