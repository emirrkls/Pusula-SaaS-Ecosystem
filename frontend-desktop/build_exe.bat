...
REM JPackage komutu:
call jpackage --type msi --name "Pusula" --app-version 3.4.0 --description "Pusula Servis Yönetimi" --vendor "Pusula" --icon "src\main\resources\app.ico" --dest target\installer --input target\jpackage-input --main-jar frontend-desktop-1.0-SNAPSHOT.jar --main-class com.pusula.desktop.Launcher --win-shortcut --win-menu --win-dir-chooser --win-upgrade-uuid "A35C7210-561A-4BB9-A499-5D4047EC0CF3"
...
echo.
echo ========================================================
echo [BASARILI] Kurulum dosyasi (Pusula-3.4.0.msi) basariyla olusturuldu!
