...
REM JPackage komutu:
call jpackage --type msi --name "Pusula" --app-version 3.2.24 --description "Pusula Servis Yönetimi" --vendor "Pusula" --icon "src\main\resources\app.ico" --dest target\installer --input target\jpackage-input --main-jar frontend-desktop-1.0-SNAPSHOT.jar --main-class com.pusula.desktop.Launcher --win-shortcut --win-menu --win-dir-chooser
...
echo.
echo ========================================================
echo [BASARILI] Kurulum dosyasi (Pusula-3.2.24.msi) basariyla olusturuldu!
