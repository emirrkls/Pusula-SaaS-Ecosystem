...
$installerPath = "target\installer\Pusula-Servis-Yonetimi-3.4.3.msi"
Copy-Item "target\installer\Pusula Servis Yonetimi-3.4.3.msi" `
...
Write-Host "Konum: frontend-desktop\target\installer\Pusula-Servis-Yonetimi-3.4.3.msi" -ForegroundColor Green
Write-Host "========================================================" -ForegroundColor Green
