...
Copy-Item "target\installer\Pusula Servis Yonetimi-3.2.13.msi" `
    -Destination "target\installer\Pusula-Servis-Yonetimi-3.2.13.msi" -Force

Write-Host ""
Write-Host "========================================================" -ForegroundColor Green
Write-Host "[BASARILI] Kurulum dosyasi basariyla olusturuldu!" -ForegroundColor Green
Write-Host "Konum: frontend-desktop\target\installer\Pusula-Servis-Yonetimi-3.2.13.msi" -ForegroundColor Green
Write-Host "========================================================" -ForegroundColor Green
pause
