...
$installerPath = "target\installer\Pusula-Servis-Yonetimi-3.5.6.msi"
Copy-Item "target\installer\Pusula Servis Yonetimi-3.5.6.msi" `
...
Write-Host "Konum: frontend-desktop\target\installer\Pusula-Servis-Yonetimi-3.5.6.msi" -ForegroundColor Green
Write-Host "========================================================" -ForegroundColor Green
