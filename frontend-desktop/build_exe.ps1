...
$installerPath = "target\installer\Pusula-Servis-Yonetimi-3.4.4.msi"
Copy-Item "target\installer\Pusula Servis Yonetimi-3.4.4.msi" `
...
Write-Host "Konum: frontend-desktop\target\installer\Pusula-Servis-Yonetimi-3.4.4.msi" -ForegroundColor Green
Write-Host "========================================================" -ForegroundColor Green
